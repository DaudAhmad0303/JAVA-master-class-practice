...
public class MethodReferenceChallenge {
    ...
    public static void main(String[] args) {
        String[] names = {"Anna", "Bob", "Carel", "David", "Emme", "Francis"};
...
//                For creating new string
                String::new,
//                s -> new String("Howdy" + s),
                String::valueOf,
//                Instance method on an instance using a bounded receiver
                tim::last,
...
//    Using the UnaryOperator is same as using a Function with Strings

...
//        Instance of top level Employee Comparator class
        var c0 = new EmployeeComparator<StoreEmployee>();
//        Instance of static nested class on Employee class
        var c1 = new Employee.EmployeeComparator<StoreEmployee>();
//        Instance of inner class on storeEmployee
...
//        Using anonymous class
        ...
        sortIt(storeEmployees, (t1, t2) -> t1.getName().compareTo(t2.getName()));

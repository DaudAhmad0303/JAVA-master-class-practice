...
//        We cannot pass directly the phones list directly to TreeSet, we'll
//        need to pass the constructor the Comparator object for this class
...
//        pollFirst will remove the first element from the set and return it.
...
//        We can also specify the ranges/boundaries to be inclusive or exclusive.

...
//            This returns zero, one or minus one
        ...
        System.out.println("B:" + (int) 'B' + "a:" + (int) 'b');
        System.out.println("P:" + (int) 'P' + "p:" + (int) 'p');

        Student tim = new Student("Time");
        Student[] students = {
                new Student("Zach"),
                new Student("Tim"),
                new Student("Ann"),
        ...
        System.out.println("result = " + tim.compareTo(new Student("TIMe")));

...
public class MapsMain {
    ...
    public static void main(String[] args) {
        ...
        addPurchase("Andy Martin", jmc, 139.99);
        addPurchase("John Martin", jmc, 139.99);
        addPurchase("Mary Martin", python, 149.99);
        addPurchase("Joe Martin", python, 139.99);
        addPurchase("Joe Jones", jmc, 149.99);
        addPurchase("Bill Brown", python, 129.99);
        addPurchase("Bill Wallets", python, 119.99);
        addPurchase("Bill Gates", python, 149.99);
